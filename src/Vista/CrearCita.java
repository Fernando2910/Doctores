...
public class CrearCita extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboBoxIdPaciente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboBoxIdPacienteActionPerformed(evt);
            }
        });
...
//        }
//        consultas.MostrarCita(jtableListaCitas);
        if (fechaSeleccionada == null || comboBoxHora.getSelectedItem() == null || comboBoxIdDoctor.getSelectedItem() == null ||
        comboBoxIdPaciente.getSelectedItem() == null || fieldDescripcion.getText().isEmpty()) {
        ...
        if (disponible) {
            ...
            // Mostrar un mensaje de que la cita no está disponible
            JOptionPane.showMessageDialog(null, "La cita seleccionada no está disponible.");
        }
        consultas.MostrarCita(jtableListaCitas);
}
    ...
    private void comboBoxIdPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboBoxIdPacienteActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_comboBoxIdPacienteActionPerformed
